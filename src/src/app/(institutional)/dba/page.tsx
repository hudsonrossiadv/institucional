// This file defines the landing page for a Defesa em Busca e Apreensão (DBA) service.
// Adaptado para o escritório HR Advocacia, com foco na defesa em busca e apreensão de veículos.
"use client"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-primary-foreground/90 leading-relaxed">
                <p>
                  O <strong>HR Advocacia</strong>, liderado pelo advogado {""}
                  <span className="font-semibold text-accent">Hudson Rossi</span>, é um
                  escritório especializado em {""}
                  <span className="font-semibold text-accent">
                    DEFESA EM BUSCA E APREENSÃO DE VEÍCULOS
                  </span>{" "}
                  e outras áreas do Direito Civil e Empresarial.
                </p>
                <p>
                  Atuando há vários anos no mercado e com experiência em casos
                  complexos, nossa missão é proteger o seu patrimônio e recuperar
                  bens apreendidos, oferecendo acompanhamento estratégico e
                  personalizado em cada etapa do processo.
                </p>
                <p>
                  Trabalhamos de forma digital e presencial, com uma equipe
                  comprometida, atendimento individualizado e comunicação clara.
                  Seja você pessoa física ou jurídica, conte com a segurança e
                  dedicação do <strong>HR Advocacia</strong> para buscar as melhores
                  soluções jurídicas para o seu caso.
                </p>
              </div>
            </motion.div>
          </div>
